...
for sample in MS11669 MS11670 MS11673 MS11674 MS11675 MS11676 MS11677 MS11678 MS11679 MS11683 MS11686 MS11770 MS11771 MS11774 MS11775 ERR5863536 SRR12455959 ERR3761407 ERR3761412;
do

metaphlan ${DATADIR}/${sample}.unmapped.fastq.gz_lowcomplexityremoved.fq.gz \
    --input_type fastq \
    --bowtie2out metaphlan/${sample}_4.1.0.bt2.out  \
    --nproc 4 \
    --bowtie2db metaphlan/metaphlan_databases \
    > metaphlan/${sample}_4.1.0.metaphlan_profile.txt
